...
@export var first_server_scene: PackedScene = preload("res://gameplay/game_management/GameManager.tscn")
@export var log_server_scene: PackedScene = preload("res://ui/screens/network/server_logs/ServerLogs.tscn")
...
func _ready():
	...
	if UserArguments.has_arg("server_launcher"):
		...
		add_logs_scene(log_server_scene)
