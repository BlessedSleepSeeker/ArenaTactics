...
@export var fallback_portrait_texture_path: String = "res://ui/characters/character_select_screen/UI/assets/base_drawing_area_portrait.png"
...
@export var module_path_template: String = "res://gameplay/character/module/%s.gd"
@export var module_class_name_template: String = "%sModule"

@export var character_scene = preload("res://gameplay/character/CharacterInstance.tscn")
